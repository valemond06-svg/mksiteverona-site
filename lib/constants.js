...
export const BRAND = {
  ...
  instagram: '@mksiteverona',
  instagram_url: 'https://instagram.com/mksiteverona',
...
export const PORTFOLIO_EXAMPLES = [
  {
    id: 1,
    title: 'Ristorante Milano',
    category: 'Ristorante',
    description: 'Sito con menù digitale, prenotazioni online e Google Maps integrato. Risultato: +35% prenotazioni.',
    image: '🍽️',
    results: ['+35% prenotazioni', 'Ordinazioni online', 'Google Maps integrato'],
  },
  {
    id: 2,
    title: 'Negozio di Abbigliamento',
    category: 'E-commerce',
    description: 'Shop online con prodotti, carrello, pagamenti Stripe. Primo mese: 50 ordini.',
    image: '👕',
    results: ['50+ ordini mese 1', 'Pagamenti sicuri', 'Analytics in tempo reale'],
  },
  {
    id: 3,
    title: 'Parrucchiera Verona',
    category: 'Salone',
    description: 'Prenotazioni online, gallery, e servizi. +40% clienti nel primo trimestre.',
    image: '✂️',
    results: ['+40% clienti', 'Prenotazioni automatiche', 'Google Maps top 3'],
  },
];
